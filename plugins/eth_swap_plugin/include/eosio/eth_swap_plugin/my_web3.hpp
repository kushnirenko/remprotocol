...
public:
    ...
    void subscribe(const std::string &contract_address, const std::string &topic,
    ...
    std::string
    new_filter(const std::string &contract_address, const std::string &fromBlock, const std::string &toBlock,
