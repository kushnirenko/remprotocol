...
namespace eosio {
   ...
   /**
    * @defgroup eosiobios remme.bios
    * @ingroup eosiocontracts
    *
    * remme.bios is a minimalistic system contract that only supplies the actions that are absolutely
    * critical to bootstrap a chain and nothing more.
    *
    * @{
    */
   class [[eosio::contract("remme.bios")]] bios : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiobios remme.bios
} /// namespace eosio
