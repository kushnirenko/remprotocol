...
namespace eosio {
   /**
    * @defgroup eosiowrap remme.wrap
    * @ingroup eosiocontracts
    * remme.wrap contract simplifies Block Producer superuser actions by making them more readable and easier to audit.
    ...
    * remme.wrap allows for a cleaner method of implementing these important governance actions.
    * @{
    */
   class [[eosio::contract("remme.wrap")]] wrap : public contract {
      public:
          ...
          * 
          * @pre Requires authorization of remme.wrap which needs to be a privileged account.
          * 
   ...
   /** @}*/ // end of @defgroup eosiowrap remme.wrap
} /// namespace eosio
