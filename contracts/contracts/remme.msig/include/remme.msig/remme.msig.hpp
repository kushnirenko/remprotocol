...
namespace eosio {
   /**
    * @defgroup eosiomsig remme.msig
    * @ingroup eosiocontracts
    * remme.msig contract defines the structures and actions needed to manage the proposals and approvals on blockchain.
    * @{
    */
   class [[eosio::contract("remme.msig")]] multisig : public contract {
      public:
   ...
   /** @}*/ // end of @defgroup eosiomsig remme.msig
} /// namespace eosio
